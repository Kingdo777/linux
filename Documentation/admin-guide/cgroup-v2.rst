...
The following nested keys are defined.
  ...
  memory.max_usage_in_pages
	...
	This value is the global watermark expressed in pages; it is not
	scaled by the page size and has no per-fd reset semantics.
	Writing to this file is not supported.
