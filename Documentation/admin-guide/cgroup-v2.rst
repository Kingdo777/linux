...
The following nested keys are defined.
  ...
  memory.max_usage_in_pages
	...
	since the creation of the cgroup, in pages.

	The value is global to the cgroup and cannot be reset: it is not
	affected by writes to memory.peak and does not change across file
	descriptors.
