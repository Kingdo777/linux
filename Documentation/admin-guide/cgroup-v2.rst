...
The following nested keys are defined.
  ...
  memory.max_usage_in_pages
	...
	The max memory usage recorded for the cgroup and its descendants since
	the creation of the cgroup (or the most recent reset of the global
	watermark), reported in page units. Unlike memory.peak, this file
	cannot be written or reset and reports the global historical peak
	without a per-fd reset semantic.
